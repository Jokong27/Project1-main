...
const searchBtn = () => {
    ...
    async function displayNames() {
        ...
        let inputValue = searchInputValue.toLowerCase().split("");
            ...
            searchCounter == 0 ? document.getElementById("errorCatcher").innerHTML = `<h4 class="orangeText">Sorry! <span>Didnt find anything for</span>  "${inputValue.join("")}"</h4>` : ``
            ...
            for (let x = 0; x <= names.length; x++) {
                let gameTitle = names[x].title.toLowerCase().split("")
